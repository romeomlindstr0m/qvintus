...
<nav class="bg-white shadow">
      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          ...
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            <a href="#" class="inline-flex items-center border-b-2 border-sky-200 px-1 pt-1 text-sm font-medium text-gray-900">Dashboard</a>
        ...
        <div class="hidden sm:ml-6 sm:flex sm:items-center">
          ...
          <div class="relative ml-3">
            ...
            <div class="hidden absolute right-0 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none" role="menu" id="user-menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
    ...
    <div class="sm:hidden hidden" id="mobile-menu">
      <div class="space-y-1 pb-3 pt-2">
        <a href="#" class="block border-l-4 border-sky-200 bg-indigo-50 py-2 pl-3 pr-4 text-base font-medium text-gray-900">Dashboard</a>
