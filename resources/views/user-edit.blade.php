...
<head>
    ...
    <title>Qvintus | Edit account</title>
...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Edit account information</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="#" method="POST">
        ...
        <div>
          <x-combobox label="Role" :options="$roles" id="1" selected_id="2" selected_name="sdgslgs" />
        </div>
